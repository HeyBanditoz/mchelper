...
public class WrappedButtonClickEvent implements Interaction {
    ...
    public WrappedButtonClickEvent(ButtonInteractionEvent event, ButtonInteractable bi, InteractionListener il) {
        this.event = event;
        this.bi = bi;
        this.il = il;
    }
    ...
    public void removeListener() {
        il.removeInteractableByButton(event.getButton());
    }
    ...
    public void destroyThenAddReplayer(MessageEmbed finalEmbed) {
        ...
        il.addInteractable(replayInteraction);
    }
